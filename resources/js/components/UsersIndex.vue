...
const defaultData = {
    ...
    filtered: [],
    columns: [
        { field: 'id', label: 'ID', visible: true, order: 1, width: 20 },
        { field: 'username', label: 'Username', visible: true, order: 2, width: 20 },
        { field: 'full_name', label: 'Full Name', visible: true, order: 3, width: 20 },
        { field: 'first_name', label: 'First Name', visible: false, order: 4, width: 20 },
        { field: 'middle_names', label: 'Middle Name(s)', visible: false, order: 5, width: 20 },
        { field: 'last_name', label: 'Last Name', visible: false, order: 6, width: 20 },
        { field: 'email', label: 'Email', visible: true, order: 7, width: 20 },
        { field: 'role_name', label: 'Role', visible: true, order: 8, width: 20 },
        { field: 'joined_at', label: 'Join Date', visible: true, order: 9, width: 20 },
        { field: 'created_at', label: 'Created Date', visible: true, order: 8, width: 20 },
        { field: 'updated_at', label: 'Updated Date', visible: true, order: 9, width: 20 },
        { field: 'active', label: 'Active', visible: true, order: 10, width: 20 },
    ],
